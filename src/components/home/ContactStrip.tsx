...
<section
  ref={sectionRef}
  className="relative overflow-hidden bg-[#F8FBFF] px-5 py-14 sm:px-8 sm:py-16 lg:px-10 lg:py-20"
>
  <div className="mx-auto max-w-5xl">
    {/* Label */}
    <div
      className={`contact-label mb-3 flex items-center justify-center gap-3 ${
    ...
    {/* Headline */}
    <h2
      className={`contact-heading mx-auto mb-4 max-w-3xl text-center text-3xl font-extrabold leading-tight text-[#102A43] sm:text-4xl lg:text-[2.6rem] ${
    ...
    {/* Subtext */}
    <p
      className={`contact-subtext mx-auto mb-12 max-w-2xl text-center text-base leading-relaxed text-[#102A43]/55 ${
        isVisible ? "contact-subtext--visible" : ""
      }`}
    >
      Visit our facility or reach out through any channel below. Our team is
      always ready to guide and support your healthcare needs.
    </p>
    ...
    {/* Divider */}
    <div
      className={`contact-divider mx-auto mt-10 h-[1px] w-full max-w-3xl bg-[#D8E8EE] ${
    ...
    {/* CTA Buttons */}
    <div
      className={`contact-ctas mt-8 flex flex-wrap items-center justify-center gap-4 ${
    ...
    >
      ...
      <a
        ...
        className="
          group relative inline-flex items-center justify-center gap-2
          overflow-hidden rounded-full border-2 border-[#01369E]
          bg-[#01369E] px-7 py-3.5 text-sm font-bold text-white
          transition-all duration-300 hover:-translate-y-0.5 hover:bg-[#002D82] hover:shadow-lg
        "
      >
    ...
    {/* Emergency notice */}
    <div
      className={`contact-notice mx-auto mt-12 flex max-w-3xl items-start gap-3 rounded-xl border border-red-200 bg-red-50 px-5 py-4 ${
