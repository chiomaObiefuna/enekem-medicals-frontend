...
const bookingServices = [
  ...
  {
    title: "Diagnostics (Ultrasound, ECG)",
    icon: Activity,
  },
  {
...
const Bookings = () => {
  ...
  const handleSubmit = async (event: SubmitEvent<HTMLFormElement>) => {
    ...
    try {
      /*
        When the backend is ready, this is where the actual API request will go.
      ...
      */
      ...
      setSubmitError("We cold not submit your booking at the moment. Please try again or coontact us on whatsapp." 
      );
    } finally {
...
Preferred date or time:`
      ...
      <section className="relative overflow-hidden bg-white px-5 py-20 sm:px-8 lg:px-10">
        ...
        <div className="relative z-10 mx-auto grid max-w-7xl gap-12 lg:grid-cols-[1fr_0.9fr] lg:items-center">
          <div className="booking-hero-copy">
            <p className="mb-5 inline-flex rounded-full border border-[#D8E8EE] bg-[#FCFDFD] px-5 py-2 text-sm font-semibold uppercase tracking-[0.2em] text-[#2F8F68]">
            ...
            <div className="mt-6 grid gap-4 sm:grid-cols-2">
              {bookingServices.map((service) => {
                ...
                return (
                  <div
                    key={service.title}
                    className="group flex items-center gap-3 rounded-2xl border border-[#D8E8EE] bg-white p-4 transition-all duration-300 hover:-translate-y-1 hover:border-[#2F8F68]/40 hover:shadow-md"
                  >
                    <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-[#F0F7FF] text-[#102A43] transition-all duration-300 group-hover:bg-[#102A43] group-hover:text-white">
  ...
  {/* Decorative left accent bar — navy → green → lime gradient */}
  <div className="absolute left-0 top-0 h-full w-1.5 rounded-l-[2rem] bg-gradient-to-b from-[#01369E] via-[#2F8F68] to-[#44CC3A]" />
            <div className="mb-8">
              <p className="mb-3 text-sm font-semibold uppercase tracking-[0.2em] text-[#2F8F68]">
                Booking Form
              </p>
            ...
            {isSubmitted && (
              <div
                className="mb-7 rounded-2xl border border-[#BFE7D0] bg-[#F3FBF6] p-5"
                aria-live="polite"
              >
            ...
            <form onSubmit={handleSubmit} noValidate className="space-y-6">
              <div className="grid gap-6 md:grid-cols-2">
                <div>
                  ...
                  <input
                    ...
                    className={`w-full rounded-2xl border bg-[#FCFDFD] px-4 py-4 text-sm text-[#102A43] outline-none transition focus:border-[#2F8F68] focus:ring-4 focus:ring-[#2F8F68]/10 ${
                      errors.fullName
                        ? "border-[#D96C6C]"
                        : "border-[#D8E8EE]"
                    }`}
              ...
              <div className="grid gap-6 md:grid-cols-2">
                <div>
                  ...
                  <input
                    ...
                    className={`w-full rounded-2xl border bg-[#FCFDFD] px-4 py-4 text-sm text-[#102A43] outline-none transition focus:border-[#2F8F68] focus:ring-4 focus:ring-[#2F8F68]/10 ${
                      errors.email ? "border-[#D96C6C]" : "border-[#D8E8EE]"
                    }`}
                  />
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={handleChange}
                    className={`w-full rounded-2xl border bg-[#FCFDFD] px-4 py-4 text-sm text-[#102A43] outline-none transition focus:border-[#2F8F68] focus:ring-4 focus:ring-[#2F8F68]/10 ${
                      errors.service ? "border-[#D96C6C]" : "border-[#D8E8EE]"
                    }`}
                  >
                    ...
                    <option value="Diagnostics (Ultrasound, ECG)">
                      Diagnostics (Ultrasound, ECG)
                    </option>
                    <option value="Pharmacy Assistance">
                      Pharmacy Assistance
                    </option>
                  </select>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      className={`w-full rounded-2xl border bg-[#FCFDFD] py-4 pl-12 pr-4 text-sm text-[#102A43] outline-none transition focus:border-[#2F8F68] focus:ring-4 focus:ring-[#2F8F68]/10 ${
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <textarea
                    ...
                    className={`w-full resize-none rounded-2xl border bg-[#FCFDFD] py-4 pl-12 pr-4 text-sm text-[#102A43] outline-none transition focus:border-[#2F8F68] focus:ring-4 focus:ring-[#2F8F68]/10 ${
                      errors.description
                        ? "border-[#D96C6C]"
                        : "border-[#D8E8EE]"
                    }`}
              ...
              <button
                ...
                className="inline-flex w-full items-center justify-center gap-2 rounded-full bg-[#102A43] px-7 py-4 text-sm font-bold text-white shadow-lg transition-all duration-300 hover:-translate-y-1 hover:bg-[#0E3442] disabled:cursor-not-allowed disabled:opacity-70 sm:w-auto"
              >
          ...
          <aside className="booking-side-panel space-y-6">
            <div className="rounded-[2rem] border border-[#D8E8EE] bg-[#F0F7FF] p-6 shadow-[0_24px_80px_rgba(16,42,67,0.06)] sm:p-8">
              <p className="mb-4 text-sm font-semibold uppercase tracking-[0.2em] text-[#2F8F68]">
                Alternative Booking Method
              </p>
              ...
              <div className="mt-6 flex flex-col gap-3">
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="inline-flex items-center justify-center gap-2 rounded-full bg-[#2F8F68] px-6 py-4 text-sm font-bold text-white shadow-lg transition-all duration-300 hover:-translate-y-1 hover:bg-[#257456]"
                >
                ...
                <a
                  ...
                  className="inline-flex items-center justify-center gap-2 rounded-full border border-[#D8E8EE] bg-white px-6 py-4 text-sm font-bold text-[#102A43] transition-all duration-300 hover:-translate-y-1 hover:border-[#2F8F68] hover:text-[#2F8F68]"
                >
            ...
            <div className="rounded-[2rem] border border-[#D8E8EE] bg-white p-6 shadow-[0_24px_80px_rgba(16,42,67,0.06)] sm:p-8">
              ...
              <div className="mt-5 space-y-4">
                {["Your full name", "Service needed", "Preferred date or time"].map(
                  (item) => (
                    <div key={item} className="flex items-center gap-3">
                      <CheckCircle2
                        size={20}
                        className="shrink-0 text-[#2F8F68]"
                        strokeWidth={2.5}
                      />
            ...
            {bookingSteps.map((step, index) => (
              <article
                ...
                className={`booking-step booking-step-delay-${
                  index + 1
                } rounded-[1.7rem] border border-[#D8E8EE] bg-[#FCFDFD] p-6 shadow-[0_18px_55px_rgba(16,42,67,0.05)]`}
              >
                <p className="text-sm font-bold text-[#2F8F68]">
                  0{index + 1}
                </p>
