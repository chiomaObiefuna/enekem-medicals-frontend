...
const NursingCare = () => {
  ...
  return (
    <main className="w-full overflow-hidden bg-[#F8FCFF] text-[#102A43]">
      {/* HERO */}
      <section className="relative overflow-hidden bg-[#3A9AD9] px-5 pt-28 pb-16 sm:px-8 lg:px-10 lg:pt-32">
        {/* Background design */}
        ...
        <div className="pointer-events-none absolute bottom-0 left-0 h-28 w-full bg-[linear-gradient(180deg,rgba(255,255,255,0),rgba(248,252,255,0.95))]" />

        <div className="relative mx-auto max-w-7xl">
          <div className="mb-10 flex flex-wrap items-center gap-2 text-sm font-semibold text-white/75">
          ...
          <div className="grid items-center gap-14 lg:grid-cols-[1fr_0.95fr]">
            ...
            <div className="nursing-hero-copy">
              ...
              <p className="mt-6 max-w-2xl text-base leading-8 text-white/85 sm:text-lg">
                Nursing Care at Enekem Medicals provides hands-on clinical
                support for patients who need wound dressing, injections,
                infusions, vital signs monitoring, post-surgical care, catheter
                care, or guidance during recovery. Our nurses support you with
                calm, professional care inside the clinic.
              </p>
  ...
  <div className="relative max-w-[420px] overflow-hidden rounded-[2rem] border-[8px] border-white bg-white shadow-[0_35px_100px_rgba(16,42,67,0.26)]">
    <img
      src={nursingImage}
      alt="Nurse at Enekem Medicals"
